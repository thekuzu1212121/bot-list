...
client.ayarlar = {
  prefix: "!", //prefix
  oauthSecret: "rFvRT4NRbh8Uge7JYC8gw-DY6oDx7k57", //bot secreti
  callbackURL: "http://astariuslist.ml/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
  rapor: "731208911050375280", /// RAPOR LOGU 
  sertifika: "731208911050375280", /// SERTIFIKA LOGU
  kayıt: "731208911050375280", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
...
client.yetkililer = [
  ...
  "478874404177051648",
  "724539739306459147"
]; //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = [
  "714451348212678658",
  "478874404177051648",
  "724539739306459147"
]; //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = [
  "714451348212678658",
  "478874404177051648",
  "724539739306459147"
]; //sunucu yetkililerin ıdleri gelcek array
...
client.on('ready', async () => {
  ...
  client.user.setActivity(`Astarius #Code #BotList`, { type:"STREAMING" })
...
NzI1NzMzOTY4MjIxMTc1OTEw.XxfrtQ.ozIgQVrcI1HPDj9yD8GzrrunvdEozIgQVrcI1HPDj9yD8GzrrunvdE
