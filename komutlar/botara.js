...
exports.run = async (client, msg, args) => {
    ...
    request(`https://astarius.cf/api/botlar/${args[0]}`, function (error, response, body) {
    ...
    .setFooter('https://astarius.cf sisteminde bot aramaktadır.')
...
exports.help = {
  name: 'bot-ara',
  description: 'Astarius sistemindeki botları aramanızı sağlar.',
